...
const generateKeyGenerator = (prefix: string) => {
...
export const extractUserMiddleware = (req: Request, res: Response, next: Function) => {
...
export const applyRateLimiting = (...limiters: any[]) => {
    return limiters;
};
